...
import memento2.Caretaker;
import java.io.IOException;
import java.util.List;
import java.util.logging.Level;
import java.util.logging.Logger;

import movestrategy2.PlayerMovementsListener;
import player2.Player;
import visitor2.IVisitor;
import visitor2.Theme1;
...
public class Controller implements Runnable, Serializable {
    ...
    public Controller(Model model, View view, String path) {
        ...
        model.setLevel(new gameobjects2.Level(this));
    ...
    public gameobjects2.Level getLevel() {
